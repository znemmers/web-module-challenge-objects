...
console.log(createMenuItem('Pepsi', 2, 'Drinks'));
...
// input: array (obj), name (str), rating (num), feedback (str)
// output: arr (obj)
// instructions/conditions: create a new object, append it to the array parameter
